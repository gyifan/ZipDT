...
#define ERODE_DEV_PATH		"/dev/erosion"
#define DEV_NAME			"erosion"
#define DEV_MAJOR			65
#define IRQ					87
#define ERODE_ADDRESS				0x68E00000
//#define EROSION_ADDRESS		ADDRESS
#define ERODE_SIZE				0x10000
#define EROSION_ADDR_SIZE	SIZE
...
#define ADDR_OFFSET_ROWS		0x14
#define ADDR_OFFSET_COLS		0x1C
#define EROSION_ADDR_OFFSET_CTRL		ADDR_OFFSET_CTRL	
#define EROSION_ADDR_OFFSET_GIE			ADDR_OFFSET_GIE		
#define EROSION_ADDR_OFFSET_IER			ADDR_OFFSET_IER		
#define EROSION_ADDR_OFFSET_ISR			ADDR_OFFSET_ISR		
#define EROSION_ADDR_OFFSET_ROWS		ADDR_OFFSET_ROWS
#define EROSION_ADDR_OFFSET_COLS		ADDR_OFFSET_COLS

//Register info for userspace accesses
#define CTL_REG				ADDR_OFFSET_CTRL
#define ROWS_REG			ADDR_OFFSET_ROWS
#define COLS_REG			ADDR_OFFSET_COLS
...
#define EROSION_CTRL_START_BIT		CTRL_START_BIT		
#define EROSION_CTRL_DONE_BIT		CTRL_DONE_BIT		
#define EROSION_CTRL_IDLE_BIT		CTRL_IDLE_BIT		
#define EROSION_CTRL_READY_BIT		CTRL_READY_BIT		
#define EROSION_CTRL_ARESTART_BIT	CTRL_ARESTART_BIT	

//Global interrupt enable masks
#define IER_GLOBAL_BIT				1<<0
#define EROSION_IER_GLOBAL_BIT		IER_GLOBAL_BIT

//IP Interrupt enable register masks
#define IER_DONE_BIT			1<<0
#define IER_READY_BIT			1<<1
#define EROSION_IER_DONE_BIT	IER_DONE_BIT
#define EROSION IER_READY_BIT	IER_READY_BIT

//IP Interrupt status register masks
#define ISR_DONE_BIT			1<<0
#define ISR_READY_BIT			1<<1
#define EROSION_ISR_DONE_BIT	ISR_DONE_BIT	
#define EROSION_ISR_READY_BIT	ISR_READY_BIT	
